...
//!
//! This module converts the modern Svelte 5 AST format to the legacy Svelte 4 AST format.
//! The conversion is based on the official Svelte compiler's legacy.js.
