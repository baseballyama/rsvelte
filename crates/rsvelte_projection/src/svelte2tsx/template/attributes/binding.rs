...
pub fn is_one_way_binding_attribute(name: &str) -> bool {
    matches!(
        name,
        "clientWidth"
            | "clientHeight"
...
pub fn one_way_binding_not_on_element_type(name: &str) -> Option<&'static str> {
    Some(match name {
        "contentRect" => "DOMRectReadOnly",
        "contentBoxSize" | "borderBoxSize" | "devicePixelContentBoxSize" => "ResizeObserverSize[]",
        "buffered" | "played" | "seekable" => "import('svelte/elements').SvelteMediaTimeRange[]",
        _ => return None,
    })
}

pub fn is_one_way_bind(name: &str) -> bool {
...
pub fn bind_is_filtered_from_props(name: &str, parent_tag: &str) -> bool {
...
pub fn bind_needs_element_var(name: &str) -> bool {
...
pub fn any_bind_needs_element_var(attributes: &[Attribute], source: &str) -> bool {
...
pub fn element_var_base_name(name: &str) -> String {
    match name {
...
pub fn sanitize_tag_for_var(name: &str) -> String {
    name.chars()
        .map(|c| {
