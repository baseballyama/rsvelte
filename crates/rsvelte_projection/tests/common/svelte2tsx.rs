//! Shared implementation for the standalone svelte2tsx fixture runner.
//!
...
/// Result status for one language-tools fixture.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum TestStatus {
    /// Projection matched the reference fixture.
    Passed,
    /// Projection completed but did not match.
    Failed,
    /// The fixture cannot be evaluated in the current checkout.
    Skipped,
    /// Projection returned an error or panicked unexpectedly.
    Error,
}
...
// =========================================================================
// Public runner used by the standalone projection fixture test.
// =========================================================================
