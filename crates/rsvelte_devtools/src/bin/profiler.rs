...
//!
//! ```text
//! cargo run --release -p rsvelte_devtools --bin profiler -- [OPTIONS]
//!
//! Options:
...
// Use mimalloc as the global allocator for this profiling executable.
// Allocator policy belongs to each devtool binary so the publishable compiler
// libraries remain neutral and embedders retain control of their process.
