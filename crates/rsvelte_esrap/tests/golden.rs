...
fn reprint(source: &str) -> Option<Reprint> {
    ...
    let comments = rsvelte_esrap::printer::build_comments(&ret.program, source);
    let mut printer =
        Printer::with_comments(&opts, comments, rsvelte_esrap::printer::line_starts(source));
