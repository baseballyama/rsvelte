...
pub(crate) fn is_native_js(p: &Path) -> bool {
    p.extension()
...
pub(crate) fn is_native_json(p: &Path) -> bool {
    p.extension()
        .and_then(OsStr::to_str)
...
pub(crate) fn is_native_css(p: &Path) -> bool {
    p.extension()
        .and_then(OsStr::to_str)
...
pub(crate) fn is_package_json(p: &Path) -> bool {
...
pub(crate) const LINE_WIDTH_MAX: u16 = 320;
...
pub(crate) const OXFMT_EXCLUDE_SVELTE: &str = "!**/*.svelte";
...
pub(crate) const OXFMT_EXCLUDE_NATIVE_JS: &[&str] = &[
    "!**/*.ts",
    "!**/*.tsx",
    "!**/*.js",
    "!**/*.jsx",
...
pub(crate) const OXFMT_EXCLUDE_NATIVE_JSON: &[&str] = &["!**/*.json", "!**/*.jsonc", "!**/*.json5"];
...
pub(crate) const OXFMT_EXCLUDE_NATIVE_CSS: &[&str] = &["!**/*.css", "!**/*.scss", "!**/*.less"];

pub(crate) fn is_svelte(p: &Path) -> bool {
