...
use crate::rules::{
    ...
    no_bind_value_on_checkable_inputs::NoBindValueOnCheckableInputs,
    no_companion_module::NoCompanionModuleShadow,
    no_conflicting_module_names::NoConflictingModuleNames,
...
pub fn all_script_rules() -> Vec<Box<dyn crate::script::ScriptRule>> {
    ...
    use crate::rules::no_navigation_without_resolve::NoNavigationWithoutResolve;
    ...
    vec![
        ...
        Box::new(crate::rules::no_navigation_without_base::NoNavigationWithoutBase),
        Box::new(NoNavigationWithoutResolve),
