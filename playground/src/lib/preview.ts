...
const IMPORT_MAP = {
	imports: {
		svelte: 'https://esm.sh/svelte@5.48.5',
		'svelte/internal/disclose-version': 'https://esm.sh/svelte@5.48.5/internal/disclose-version',
		'svelte/internal/client': 'https://esm.sh/svelte@5.48.5/internal/client'
	}
};
