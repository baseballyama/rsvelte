...
`lsp-known-failures.json` contains 23088 entries. Fixture and upstream entries identify one normalized
...
Partition of `lsp-known-failures.json` by key kind: `21608 + 1188 + 292` — real-world corpus
...
Partition of `lsp-known-failures.json` by request phase: `11549 + 11539`
