...
`lsp-known-failures.json` contains 24110 entries. Fixture and upstream entries identify one normalized
...
Partition of `lsp-known-failures.json` by key kind: `22032 + 1744 + 334` — real-world corpus
...
Partition of `lsp-known-failures.json` by request phase: `12060 + 12050`
...
Partition of `lsp-known-failures.json` entries under `aggregate:corpus/` by repository: `3662 + 7672 + 258 + 10440`
