...
`lsp-known-failures.json` contains 23838 entries. Fixture and upstream entries identify one normalized
...
Partition of `lsp-known-failures.json` by key kind: `21792 + 1728 + 318` — real-world corpus
...
Partition of `lsp-known-failures.json` by request phase: `11924 + 11914`
