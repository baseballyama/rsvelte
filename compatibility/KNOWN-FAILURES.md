...
`lsp-known-failures.json` contains 23056 entries. Fixture and upstream entries identify one normalized
...
Partition of `lsp-known-failures.json` by key kind: `21562 + 1192 + 302` — real-world corpus
...
Partition of `lsp-known-failures.json` by request phase: `11533 + 11523`
