...
`lsp-known-failures.json` contains 23096 entries. Fixture and upstream entries identify one normalized
...
Partition of `lsp-known-failures.json` by key kind: `21580 + 1214 + 302` — real-world corpus
...
Partition of `lsp-known-failures.json` by request phase: `11553 + 11543`
