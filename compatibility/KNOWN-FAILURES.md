...
`lsp-known-failures.json` contains 23086 entries. Fixture and upstream entries identify one normalized
...
Partition of `lsp-known-failures.json` by key kind: `21562 + 1216 + 308` — real-world corpus
...
Partition of `lsp-known-failures.json` by request phase: `11548 + 11538`
