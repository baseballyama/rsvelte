...
`lsp-known-failures.json` contains 23180 entries. Fixture and upstream entries identify one normalized
...
Partition of `lsp-known-failures.json` by key kind: `21562 + 1310 + 308` — real-world corpus
...
Partition of `lsp-known-failures.json` by request phase: `11595 + 11585`
