...
## Client (`known-failures.client.json`, 423 entries)

Partition of `known-failures.client.json` by verdict: `327 + 36 + 20 + 37 + 3`

- **327 — the generated JS differs** (`js` / `code-differs`).
...
Every one of the 423 arrived with the wave-2 enrolment (#3130) and is described
...
## Client dev (`known-failures.client-dev.json`, 460 entries)

Partition of `known-failures.client-dev.json` by verdict: `366 + 36 + 20 + 34 + 4`

- **366 — the generated JS differs.**
- **36 — both compilers reject with a different error code.**
...
All 460 arrived with the wave-2 enrolment (#3130); this target was at 0 before
