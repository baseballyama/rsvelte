...
## Client (`known-failures.client.json`, 436 entries)

Partition of `known-failures.client.json` by verdict: `338 + 36 + 20 + 37 + 5`
...
- **5 — rsvelte's output is not JavaScript**, ratcheted in full in
...
Every one of the 436 arrived with the wave-2 enrolment (#3130) and is described
...
## Client dev (`known-failures.client-dev.json`, 474 entries)

Partition of `known-failures.client-dev.json` by verdict: `378 + 36 + 20 + 34 + 6`
...
- **6 — rsvelte's output is not JavaScript.**

All 474 arrived with the wave-2 enrolment (#3130); this target was at 0 before
