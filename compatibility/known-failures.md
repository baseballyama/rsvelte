...
## Client (`known-failures.client.json`, 434 entries)

Partition of `known-failures.client.json` by verdict: `338 + 36 + 20 + 37 + 3`
...
Every one of the 434 arrived with the wave-2 enrolment (#3130) and is described
...
## Client dev (`known-failures.client-dev.json`, 472 entries)

Partition of `known-failures.client-dev.json` by verdict: `378 + 36 + 20 + 34 + 4`
...
All 472 arrived with the wave-2 enrolment (#3130); this target was at 0 before
