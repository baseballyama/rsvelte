...
## Client (`known-failures.client.json`, 424 entries)

Partition of `known-failures.client.json` by verdict: `328 + 36 + 20 + 37 + 3`

- **328 — the generated JS differs** (`js` / `code-differs`).
...
Every one of the 424 arrived with the wave-2 enrolment (#3130) and is described
...
## Client dev (`known-failures.client-dev.json`, 461 entries)

Partition of `known-failures.client-dev.json` by verdict: `367 + 36 + 20 + 34 + 4`

- **367 — the generated JS differs.**
- **36 — both compilers reject with a different error code.**
...
All 461 arrived with the wave-2 enrolment (#3130); this target was at 0 before
