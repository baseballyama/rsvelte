...
**予測される比 = (100 + N) / N。実測の Σstages/parent と全 8 コーパスで一致した:**
smelte 74 → 予測 2.00 / 実測 2.01、sveltestrap 129 → 1.78 / 1.70、
svelte-ux 198 → 1.51 / 1.76、bits-ui 617 → 1.16 / 1.12、skeleton 686 → 1.15 / 1.13、
flowbite 1296 → 1.08 / 1.16、layerchart 1400 → 1.07 / 1.03、shadcn 1682 → 1.06 / 1.08。
