...
export const delegated: EcoComponent[] = [
  ...
  },
  {
    ...
    status: "delegated",
    blurb:
      "A thin wrapper around sass / postcss / ts — all JS-heavy. Nothing to gain by porting the wrapper itself.",
  },
  {
    name: "mdsvex",
    dropInFor: "mdsvex",
  ...
  },
  {
    ...
    status: "delegated",
    blurb:
      "A whole framework, deeply coupled to Vite / Rollup. Out of scope — specific hot paths may be revisited later.",
  },
];
