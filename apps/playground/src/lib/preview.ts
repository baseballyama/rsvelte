...
const IMPORT_MAP = {
  imports: {
    svelte: "https://esm.sh/svelte@5.57.1",
    "svelte/internal/disclose-version": "https://esm.sh/svelte@5.57.1/internal/disclose-version",
    "svelte/internal/client": "https://esm.sh/svelte@5.57.1/internal/client",
  },
};
