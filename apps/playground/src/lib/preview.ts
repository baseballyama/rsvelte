...
const IMPORT_MAP = {
	imports: {
		svelte: 'https://esm.sh/svelte@5.56.2',
		'svelte/internal/disclose-version': 'https://esm.sh/svelte@5.56.2/internal/disclose-version',
		'svelte/internal/client': 'https://esm.sh/svelte@5.56.2/internal/client'
	}
};
