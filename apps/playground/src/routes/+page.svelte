...
<svelte:head>
	...
	<meta
		name="description"
		content="A Rust port of the Svelte ecosystem — compiler, svelte2tsx, svelte-check, fmt and vite-plugin-svelte as drop-in replacements. Same surface, identical output, up to 278× faster."
	/>
</svelte:head>
...
<div class="page" class:in={animated}>
	...
	<header class="hero">
		...
		<p class="lede">
			...
			<span class="ink-svelte">{bench ? Math.round(maxSpeedup) : 278}×</span> faster.
		</p>
