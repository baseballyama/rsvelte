...
const {
  ...
  preprocess,
  VERSION,
} = require("@rsvelte/vite-plugin-svelte-native");
...
- `VERSION` tracks the upstream Svelte version (currently `5.51.3`) — it's the _Svelte_ compatibility line, not the rsvelte release version.
