...
#
# Usage:
#   ./scripts/bench.sh              # Run full JS vs Rust comparison
#   ./scripts/bench.sh --criterion  # Run Criterion micro-benchmarks
#   ./scripts/bench.sh --profile    # Run profiler on a single large file
#   ./scripts/bench.sh --quick      # Quick single-threaded-only comparison
#
# Prerequisites:
