...
//
// Usage:
//   node scripts/ecosystem-ci-issues.mjs
//
...
function renderHistoryBody(entries, nowIso) {
	...
	return [
		...
		`Tracking the most recent ${HISTORY_MAX_ROWS} runs of \`ecosystem-ci\`. ` +
			'Updated automatically by `scripts/ecosystem-ci-issues.mjs`. ' +
...
function renderFailureBody(ctx, results, summary) {
	...
	lines.push('');
	lines.push(
		'_This issue was opened automatically by `scripts/ecosystem-ci-issues.mjs`. ' +
