...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-D80PhhP9.js"));
	try {
...
var estreePlugin = createParsersAndPrinters([{
	importPlugin: () => import("./estree-Dbhq_ls-.js"),
...
var { parsers, printers } = createParsersAndPrinters([
	{
		importPlugin: () => import("./acorn-Dg33ba6P.js"),
		parsers: ["acorn", "espree"]
	},
	{
		importPlugin: () => import("./angular-uNZxEOkz.js"),
		parsers: [
			"__ng_action",
			"__ng_binding",
			"__ng_interpolation",
	...
	{
		importPlugin: () => import("./babel-DRBVrtWu.js"),
		parsers: [
			"babel",
			"babel-flow",
			"babel-ts",
	...
	{
		importPlugin: () => import("./flow-CgDiNJJ7.js"),
		parsers: ["flow"]
	},
	{
		importPlugin: () => import("./glimmer-DM-kBOhf.js"),
		parsers: ["glimmer"],
		printers: ["glimmer"]
	},
	{
		importPlugin: () => import("./graphql-b892kzpi.js"),
		parsers: ["graphql"],
		printers: ["graphql"]
	},
	{
		importPlugin: () => import("./html-DpUYmEEC.js"),
		parsers: [
			"html",
			"angular",
			"vue",
	...
	{
		importPlugin: () => import("./markdown-DTqaZ9x0.js"),
		parsers: [
			"markdown",
			"mdx",
			"remark"
	...
	{
		importPlugin: () => import("./meriyah-B2C-4qZy.js"),
		parsers: ["meriyah"]
	},
	{
		importPlugin: () => import("./postcss-BBCUMS7u.js"),
		parsers: [
			"css",
			"less",
			"scss"
	...
	{
		importPlugin: () => import("./typescript-XwnBEa56.js"),
		parsers: ["typescript"]
	},
	{
		importPlugin: () => import("./yaml-D80PhhP9.js"),
		parsers: ["yaml"],
		printers: ["yaml"]
	}
]);
